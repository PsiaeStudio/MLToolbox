...
@Composable
fun InstallUe4ssModScreen(
    screenState: InstallUe4ssModScreenState
) {
                        ...
                        Column(
                            ...
                            val str = buildAnnotatedString {
                                ...
                                withStyle(Material3Theme.typography.bodySmall.toSpanStyle()) {
                                    ...
                                    append("\n")
                                    append("*note: make sure UE4SS Mod Loader is already installed")
                                }
                            }
                            ...
                            HeightSpacer(32.dp)
                            SelectUE4SSModArchiveUICard(screenState, snackbarState, Modifier)
                            Box(
...
@Composable
private fun SelectUE4SSModArchiveUICard(
    state: InstallUe4ssModScreenState,
    ...
    Column(
        ...
        BoxWithConstraints(
            ...
            ElevatedCard(
                ...
                if (state.isLoading) {
                ...
                } else if (/*state.selectedUE4SSArchive == null*/ true) {
                    val dragAndDropTarget = remember {
                        object : DragAndDropTarget {
                            ...
                            override fun onDrop(event: DragAndDropEvent): Boolean {
                                draggingInBoundState.value = false
                                state.dragAndDropUe4ssModArchives(
                    ...
                    Column(
                        Modifier
                                ...
                                shouldStartDragAndDrop = { event ->
                                    ...
                                    val accept = dragData is DragData.FilesList &&
                                        dragData.readFiles().let { files ->
                                            files.size <= 256 && files.all { uriStr ->
                            ...
                            .clickable { state.pickUe4ssModArchives(null) }
                            .padding(24.dp),
                        verticalArrangement = Arrangement.Center,
                        horizontalAlignment = Alignment.CenterHorizontally
                    ) {
