...
@Composable
fun InstallUe4ssScreen(
    screenState: InstallUe4ssScreenState
) {
                ...
                Row {
                    Column(
                        ...
                        Column(
                            ...
                            HeightSpacer(32.dp)
                            SelectUE4SSArchiveUICard(screenState, snackbarState, Modifier)
                            Box(
                ...
                if (state.isLoading) {
                    ...
                    val dragAndDropTarget = remember {
                        object : DragAndDropTarget {
                            ...
                            override fun onDrop(event: DragAndDropEvent): Boolean {
                                draggingInBoundState.value = false
                                state.dragAndDropUe4ssArchive(
                                    (event.dragData() as DragData.FilesList).readFiles().first()
                                )
                                return true
                            }
                        }
                    ...
                    Column(
                        Modifier
                                ...
                                shouldStartDragAndDrop = { event ->
                                    ...
                                    val accept = dragData is DragData.FilesList &&
                                        dragData.readFiles().let { files ->
                                            files.size == 1 && files.first().let { uriStr ->
                            ...
                            .clickable { state.pickUe4ssArchive(null) }
                            .padding(24.dp),
                        verticalArrangement = Arrangement.Center,
                        horizontalAlignment = Alignment.CenterHorizontally
                    ) {
