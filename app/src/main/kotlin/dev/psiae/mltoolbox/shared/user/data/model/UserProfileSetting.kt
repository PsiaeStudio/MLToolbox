...
import dev.psiae.mltoolbox.data.proto.user.profile.ProfileSetting as ProtoProfileSetting
...
data class UserProfileSetting(
    ...
    companion object {
        ...
        fun from(proto: ProtoProfileSetting): UserProfileSetting {
        ...
        fun UserProfileSetting.toProto(): ProtoProfileSetting {
            val personalization = run {
                val theme = run {
                    ProtoProfileSetting.Personalization.Theme.newBuilder()
                ...
                ProtoProfileSetting.Personalization.newBuilder()
                    .setTheme(theme)
                    .build()
            }
            return ProtoProfileSetting.newBuilder()
    ...
    object JetpackDataStoreSerializer : androidx.datastore.core.Serializer<UserProfileSetting> {
        ...
        override suspend fun readFrom(input: InputStream): UserProfileSetting {
            return try {
                UserProfileSetting.from(ProtoProfileSetting.parseFrom(input))
