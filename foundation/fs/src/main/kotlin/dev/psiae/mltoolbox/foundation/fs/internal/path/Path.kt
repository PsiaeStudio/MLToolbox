 ...
 */
package dev.psiae.mltoolbox.foundation.fs.internal.path
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.isRelative(): Boolean {
  return rootLength() == -1
}

@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.volumeLetter(): Char? {
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.nameBytes(): ByteString {
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.name(): String {
  return nameBytes.utf8()
}

@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.parent(): Path? {
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.resolveImpl(child: String, normalize: Boolean): Path {
    return resolveImpl(Buffer().writeUtf8(child), normalize = normalize)
}

@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.resolveImpl(child: Buffer, normalize: Boolean): Path {
    return resolveImpl(child.toPath(normalize = false), normalize = normalize)
}

internal fun Path.resolveImpl(child: Path, normalize: Boolean): Path {
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.relativeToImpl(other: Path): Path {
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.root(): Path? {
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.segments(): List<String> {
  return segmentsBytes().map { it.utf8() }
}

/** This function skips the root then splits on slash. */
@Suppress("NOTHING_TO_INLINE")
internal inline fun Path.segmentsBytes(): List<ByteString> {
